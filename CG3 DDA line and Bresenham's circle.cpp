/* 
   AIM:- write c++ prgram to draw the following pattern use DDA line and Bresenham Circle drawing algo.apply the concept of incapsulation */
...
user@user:~$ g++ Exp1.cpp -o 1 -lgraph
user@user:~$ ./1
